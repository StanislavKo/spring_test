...
(function($) {
	...
	_pSort.__sortLocalData = function(sorters, data) {
		...
		for (var i = 0; i < sorters.length; i++) {
			var sorterObj = {
					dataIndx: sorters[i].dataIndx,
					dataType: sorters[i].dataType,
					dir: sorters[i].dir
			};
			sorters2[i] = sorterObj;
//			sorters2[sorters2.legnth] = new Object;
//			sorters2[sorters2.legnth - 1].dataIndx = sorters[i].dataIndx;
//			sorters2[sorters2.legnth - 1].dataType = sorters[i].dataType;
//			sorters2[sorters2.legnth - 1].dir = sorters[i].dir;
		}
		for (var i = 0; i < sorters2.length; i++) {
			var sorter = sorters2[i],
				dataIndx = sorter.dataIndx;
			if (DM.sortMap != null && DM.sortMap[dataIndx] != undefined) {
//				dataType = DM.sortMap[dataIndx].dataType;
				sorter.dataIndx = DM.sortMap[dataIndx].dataIndx;
				sorter.dataType = DM.sortMap[dataIndx].dataType;
			}
		}
